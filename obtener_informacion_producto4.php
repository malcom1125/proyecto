...
<body>
    ...
    <img src="images/foto4.jfif" alt="foto de librito" width="200px">
    <div class="producto-info">
        <?php
        // Simula la obtención de información del producto desde una fuente de datos
        $producto = array(
            'nombre' => 'Producto: libreta',
            'descripcion' => 'Este libreta esta hecha 100% dede 0.',
            'precio' => '$2.000',
            'caracteristicas' => array(
                'tematica: Cafe de Colombia en homero',
                'Tamaño: pequeño',
                'Disponible: Sí'
            )
        );
